...
![Build](https://github.com/inpot/mvvmTemplateKt/workflows/Build/badge.svg)
...
- Using IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "mvvmTemplateKt"</kbd> >
  <kbd>Install Plugin</kbd>
  
- Manually:

  Download the [latest release](https://github.com/inpot/mvvmTemplateKt/releases/latest) and install it manually using
